...
import {
    useSpendPlanDraftManyQuery as useManyQuery,
    useSpendPlanDraftRemoveByIdMutation as useRemoveByIdMutation,
    SpendPlanDraft as ItemType,
    SpendPlanDraftManyDocument as ManyDocument,
    SpendPlanDraftManyQuery as ManyQuery,
    SpendPlanDraftRemoveByIdMutation as RemoveByIdMutation,
} from '../../generated/graphql';

const resourceName = 'SpendPlanDraft';
const resourceNamePlural = 'SpendPlanDrafts';
const parseManyResponse = (data?: ManyQuery): ItemType[] => {
    return (data?.SpendPlanDraftMany as ItemType[]) || [];
};
const parseRemoveByIdResponse = (
    data?: RemoveByIdMutation,
): ItemType | undefined => {
    return data?.SpendPlanDraftRemoveById as ItemType;
};
