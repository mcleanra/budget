...
import {
    useSpendPlanDraftByIdLazyQuery as useByIdLazyQuery,
    useSpendPlanDraftCreateOneMutation as useCreateOneMutation,
    useSpendPlanDraftUpdateByIdMutation as useUpdateByIdMutation,
    SpendPlanDraftManyDocument as ManyDocument,
    SpendPlanDraftByIdQuery as ByIdQuery,
    SpendPlanDraftCreateOneMutation as CreateOneMutation,
} from '../../generated/graphql';

const parseCreateOneResponse = (data?: CreateOneMutation) =>
    data?.SpendPlanDraftCreateOne;

const parseByIdResponse = (data?: ByIdQuery) =>
    data?.SpendPlanDraftById;

const redirectToAllItemsPath = () =>
    routeConfig.SpendPlanDraftMany.path;
...
const CreateOrEdit: React.FC = () => {
    ...
    const onSubmit = async (formData: FormData) => {
        if (!id) {
            ...
            if (createdItem) {
                addToast(
                    `'${createdItem._id}' has been created.`,
